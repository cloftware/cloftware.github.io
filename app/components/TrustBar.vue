...
const items = ['Enterprise Ready', 'Cloud Native', 'Secure Development', 'AI Powered', 'Agile Delivery', '24/7 Support']
const duplicatedItems = [...items, ...items, ...items].map((label, index) => ({ label, key: `${label}-${index}` }))
</script>
